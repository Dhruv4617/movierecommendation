...
filename = 'The-Movie-Cinema-master\model.pkl'
clf = pickle.load(open(filename, 'rb'))
vectorizer = pickle.load(open('The-Movie-Cinema-master\model1.pkl','rb'))
...
def get_suggestions():
    data = pd.read_csv('The-Movie-Cinema-master\main_data.csv')
